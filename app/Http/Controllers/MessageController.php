    ...
    public function store(Request $request)
    {
        if (isset($request->message)) {
            ...
            if (isset($request->message['text']) && $request->message['text'] == '/start') {
                $this->telegram->sendButtons($chat_id, "Assalomu Alaykum yaxshimisiz. Men yo'naltirilgan xabarlarni kunning qaysidir vaqtlarida jadval asosida guruhga jo'natadigan botman. Iltimos, hafta kunini belgilang:", $this->buttons->report_buttons);
            }
            ...
            elseif (isset($request->message['forward_from']) || isset($request->message['forward_from_chat'])) {
